...
const NUMERIC_NAMES: Record<string, string> = {
  ...
  '465': 'ERR_YOUREBANNEDCREEP', '470': 'ERR_LINKCHANNEL', '471': 'ERR_CHANNELISFULL', '472': 'ERR_UNKNOWNMODE',
  '473': 'ERR_INVITEONLYCHAN', '474': 'ERR_BANNEDFROMCHAN', '475': 'ERR_BADCHANNELKEY',
  '476': 'ERR_BADCHANMASK', '477': 'ERR_NEEDREGGEDNICK', '481': 'ERR_NOPRIVILEGES', '482': 'ERR_CHANOPRIVSNEEDED',
  '483': 'ERR_CANTKILLSERVER', '489': 'ERR_SECUREONLYCHAN', '491': 'ERR_NOOPERHOST', '501': 'ERR_UMODEUNKNOWNFLAG',
  '502': 'ERR_USERSDONTMATCH', '519': 'ERR_ADMONLYCHAN', '520': 'ERR_OPERONLYCHAN',
  '524': 'ERR_HELPNOTFOUND', '525': 'ERR_INVALIDKEY',
  ...
  '733': 'RPL_ENDOFMONLIST', '734': 'ERR_MONLISTFULL',
  '735': 'RPL_KEYVALUE', '742': 'ERR_MLOCKRESTRICTED', '759': 'RPL_ETRACEEND',
  '940': 'RPL_ENDOFSPAMFILTER', '941': 'RPL_SPAMFILTER',
...
const ERROR_CODES = new Set([
  ...
  '465', '471', '472', '473', '474', '475', '476', '477', '481', '482', '483', '489', '491', '501',
  '502', '519', '520', '524', '525', '691', '696', '723', '734', '902', '904', '905', '906', '907',
]);
